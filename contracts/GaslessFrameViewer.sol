...
/**
 * @title GaslessFrameViewer
 * @dev Contract for gasless frame viewing - deposit once, spend automatically
 * @dev Perfect for Privy embedded wallets with gasless transactions
 */
contract GaslessFrameViewer is Ownable, ReentrancyGuard {
    ...
    /**
     * @dev Deposit MON to the contract for gasless frame viewing
     */
    ...
    /**
     * @dev View a specific frame - only frames 1 and 162 cost MON
    ...
    function viewFrame(uint256 frameNumber) external nonReentrant {
        ...
        if (frameNumber == 1) {
            ...
            require(userBalances[msg.sender] >= FRAME_COST, "Insufficient balance for slap start");
            ...
            require(userBalances[msg.sender] >= FRAME_COST, "Insufficient balance for slap end");
        ...
        emit FrameViewed(msg.sender, frameNumber, cost);
    }
